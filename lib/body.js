...
var _formdataPolyfill = require("./vendor/formdata-polyfill");
...
class Body {
  constructor(body, {
    ...
    } else if (body instanceof _formdataPolyfill.FormData) {
      // Body is FormData
      body = (0, _formdataPolyfill.formDataToBlob)(body);
  ...
  async formData() {
    ...
    if (ct.startsWith('application/x-www-form-urlencoded')) {
      const formData = new _formdataPolyfill.FormData();
...
const extractContentType = (body, request) => {
  ...
  if (body instanceof _formdataPolyfill.FormData) {
