...
/* c8 ignore next 9 */
const validateHeaderName = typeof _nodeHttp.validateHeaderName === 'function' ? _nodeHttp.validateHeaderName : name => {
  if (!/^[\^`\-\w!#$%&'*+.|~]+$/.test(name)) {
...
const validateHeaderValue = typeof _nodeHttp.validateHeaderValue === 'function' ? _nodeHttp.validateHeaderValue : (name, value) => {
  if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(value)) {
    ...
    if (init instanceof Headers) {
      ...
      if (method == null) {
        ...
        result = [...init].map(pair => {
          if (typeof pair !== 'object' || _nodeUtil.types.isBoxedPrimitive(pair)) {
